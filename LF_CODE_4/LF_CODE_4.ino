...
// ==========================================
// TUNING VARIABLES (MATHEMATICAL BASELINE)
// ==========================================
...
// PID Constants derived for a 110 base speed and 1500 max error
float Kp = 0.07;   
float Ki = 0.0;    // Disabled to completely eliminate U-turn memory windup
float Kd = 1.0;    // Roughly 14x Kp to act as the dampener
...
// ==========================================
// MANUAL CALIBRATION (HIGH RELIABILITY)
// ==========================================
...
void followLinePID() {
  ...
  // Anti-windup (Kept in case you ever re-enable Ki)
  integral += error;
  ...
  if (error <= -1500) {
    ...
    // Normal turning constraints. Minimum -20 to prevent spin-outs on U-turns.
